			...
			<div class="m-auto pb-44 flex flex-col justify-center">
				<div class="max-w-md">
					...
					<div class=" mt-4 text-center text-sm w-full">
						{$i18n.t(
							"Oops! You're using an unsupported method (frontend only). Please serve the JameelAI from the backend."
						)}
						...
						<a
							...
							href="https://github.com/JameelAI/JameelAI#how-to-install-"
							target="_blank">{$i18n.t('See readme.md for instructions')}</a
						>
						{$i18n.t('or')}
						<a class=" font-medium underline" href="" target="_blank"
							>{$i18n.t(' help.')}</a
						>
					</div>
