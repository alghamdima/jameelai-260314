...
<div class="flex flex-col h-full justify-between text-sm" id="tab-general">
	<div class="  overflow-y-scroll max-h-[28rem] md:max-h-full">
		<div class="">
			<div class=" mb-1 text-sm font-medium">{$i18n.t('JameelAI Settings')}</div>
				...
				>
					<a
						class="font-medium underline {($settings?.highContrastMode ?? false)
							...
							: 'text-gray-300'}"
						href="https://github.com/jameelai/jameelai/blob/main/docs/CONTRIBUTING.md#-translations-and-internationalization"
						target="_blank"
					>
					</a>
				</div>
